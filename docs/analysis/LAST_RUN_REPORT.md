...
**Output:**
```json
{"status":"ok","php_version":"8.2.12","has_pdo":true,"has_pdo_sqlite":true,"sqlite_db_path":"[redacted]","can_write_db":true,"can_write_cache":true,"timestamp":"2025-12-26T10:49:08+11:00","timezone":"Australia/Melbourne"}
```
